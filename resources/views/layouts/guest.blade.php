...
<head>
    ...
    <title>Gift Reminder & Management Platform</title>
...
<body class="font-sans antialiased bg-canvas text-stone-700 flex flex-col min-h-screen">
    ...
    <nav class="w-full py-6 px-6 md:px-12 flex justify-between items-center max-w-7xl mx-auto">
        ...
        <div class="hidden md:flex items-center gap-8 text-sm font-medium">
            <a href="#" class="hover:text-brand-600 transition">Features</a>
            <a href="#" class="hover:text-brand-600 transition">Pricing</a>
            <div class="flex items-center gap-4 ml-4">
                <a href="{{ route('login') }}" class="text-stone-600 hover:text-stone-900">Log in</a>
                <a href="#" class="bg-brand-600 hover:bg-brand-700 text-white px-5 py-2.5 rounded-full shadow-md hover:shadow-lg transition transform hover:-translate-y-0.5">
                    Get Started
                </a>
            </div>
        </div>
    ...
    <footer class="bg-stone-100 border-t border-stone-200 mt-20 py-12">
        <div class="max-w-7xl mx-auto px-6 text-center md:text-left md:flex justify-between items-center">
            <div class="mb-4 md:mb-0">
                <p class="text-sm text-stone-500">&copy; {{ date('Y') }} Gift Reminder Platform. All rights reserved.</p>
            </div>
